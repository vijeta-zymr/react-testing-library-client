...
test("Order phases for happy path", async () => {
  ...
  const scoopsHeading = screen.getByRole("heading", { name: "Scoops: $60.00" });
  ...
  const scoopsTotal = await screen.findByText(
    "Scoops: $20.00 each, total: $0.00"
  );
  expect(scoopsTotal).toBeInTheDocument();
  const toppingsTotal = screen.getByText("Toppings: $15.00 each, total: $0.00");
